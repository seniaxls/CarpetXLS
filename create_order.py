...
from orders.models import Order, Product, ProductAdd, ProductOrder, Stage, SecondProductOrder, SecondProduct  # Замените "your_app" на имя вашего приложения
...
def create_orders(num_orders=10):
    ...
    for _ in range(num_orders):
        ...
        order = Order.objects.create(
            client=client,
            user=random_choice(User.objects.all()),
