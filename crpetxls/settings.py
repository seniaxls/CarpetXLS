"""
Django settings for crpetxls project.
...
WSGI_APPLICATION = 'crpetxls.wsgi.application'
...
STATIC_ROOT = os.path.join(os.path.dirname(BASE_DIR), "./crpetxls/static_cdn")
